...
[Download the latest release (version 0.6.0)](https://raw.githubusercontent.com/peter88213/yw2md/master/dist/yw2md_v0.6.0.zip)

* Unzip the downloaded zipfile "yw2md_v0.6.0.zip" into a new folder and open "README.md" for usage instructions.
