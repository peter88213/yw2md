...
[Download the latest release (version 1.3.2)](https://raw.githubusercontent.com/peter88213/yw2md/master/dist/yw2md_v1.3.2.zip)

* Unzip the downloaded zipfile "yw2md_v1.3.2.zip" into a new folder and open "README.md" for usage instructions.
